...
//            "aaSorting": [[4, "desc"]],
                ...
                ajax: function (data, callback, settings) {
                    ...
                    $.ajax({
                        type: "post",
                        url: global_path + "/cms/user/getRoleList",
                        cache: false,  //禁用缓存
                        data: param,  //传入组装的参数
                        dataType: "json",
                ...
                columns: [
                    ...
                    //员工
                    {
                        ...
                        "render": function (data, type, full, meta) {
                            var node = '';
                            node = '<div class="widthCtrl text-center" title="'+full.username+'">'+full.username+'</div>';
                            return node;
                        }
                    },
                    //操作
                    {
                        ...
                        "render": function (data, type, full, meta) {
                            var node = '';
                            node = '<a class="btn btn-skyBlueSmall" href="jurAllot.html?roleId='+full.roleId+'">权限管理</a>';
                            return node;
         ...
         * */
        buildRole:function () {
            $('#buildNew').modal({backdrop: 'static', keyboard: false});
        },
        /**
         * 取消
         * */
        ...
        buildEnter:function () {
            var _this = this;
            $.ajax({
                url:global_path + '/cms/user/addRole',
                type:'post',
                dataType:'json',
                data:{
                    token: _this.token,
