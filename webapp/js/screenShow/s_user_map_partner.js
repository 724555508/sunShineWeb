    ...
    methods:{
        ...
        mySwiper: function () {
            var mySwiper = new Swiper ('.swiper-container', {
                direction: 'horizontal',    //方向  ||竖vertical  ||横horizontal
                loop: false,         //循环
                autoplay : 15000,    //自动播放
                speed: 1000,        //切换速度
                initialSlide :0,            //起始显示
                //autoplayDisableOnInteraction : false,   //拖拽后不继续执行自动切换 ||false为继续自动 ||true为不切换
                //grabCursor : true,  //鼠标变为手掌形状
                // 如果需要分页器
        ...
        setMap: function (zoom,center,data){
            ...
            //加载行政区划插件
            // _this.addArea(map,'内蒙古','red');
            // _this.addArea(map,'山西','blue');
            // _this.addArea(map,'运城','yellow');
            // _this.addArea(map,'河南','purple');
            // _this.addArea(map,'新疆','pink');
            // _this.addArea(map,'辽宁','green');
            // _this.addArea(map,'山东','gray');
            // _this.addArea(map,'四川','green');
            // _this.addArea(map,'甘肃','red');
            // _this.addArea(map,'西安','grown');
            // _this.addArea(map,'云南','white');
            // _this.addArea(map,'丽江','skyblue');
            // _this.addArea(map,'西双版纳','green');
            // _this.addArea(map,'吉林','deeppink');
            // _this.addArea(map,'','green');
            // _this.addArea(map,'','green');
            // _this.addArea(map,'湖南','black');
        },
        /**
         * 地图2
         * */
